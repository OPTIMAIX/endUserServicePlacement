...
if __name__ == '__main__':
    setup_dict = {
        'name': 'NFPlanningSolverStructs-R2023a',
        'version': '9.14',
        'description': 'A Python interface to NFPlanningSolverStructs',
        'author': 'MathWorks',
        'url': 'https://www.mathworks.com/',
        'platforms': ['Linux', 'Windows', 'macOS'],
        'packages': [
            'NFPlanningSolverStructs'
        ],
        'package_data': {'NFPlanningSolverStructs': ['*.ctf']}
    }
