...
filename = sprintf('resultadosMinCost_%s.csv', dateRun);
...
for Exp = 1:1
    for ct = 5:5 %cloud types
        for st = 5:5 % service types,
            ...
            [x_opt, f_opt, exitflag, output] = milpsolver(b,s,c,beta,sigma,kapa,d,D,p); 
